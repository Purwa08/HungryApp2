...
int main()
{
    ...
    do
    {
        ...
        case 4:
            ...
            //     char n[50], addr[50], res[50], menu[50];
            //     int id,uid, no, d, m, y;
            //     date dt;
            ...
            //     printf("Enter name of restuarant\n");
            //     scanf("%s", res);

            //     printf("Enter ordered food\n");
            //     scanf("%s", menu);
            ...
            //     order(id,uid, n, addr, no, res, menu, dt);
        ...
        case 12:
            ...
            break;
        case 13:
            print_res_details(res_root, "Restaurant1", "Address1");
            break;
        case 14:
